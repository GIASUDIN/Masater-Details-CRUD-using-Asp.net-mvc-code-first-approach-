...
using CF_Exam_7.Models.ViewModels;
using static System.Net.WebRequestMethods;

namespace CF_Exam_7.Controllers
{
    public class OrderController : Controller
    {
        ...
        //{
        //    List<OrderMaster> orderMasters = db.OrderMasters.Include(o => o.OrderDetails).ToList();
